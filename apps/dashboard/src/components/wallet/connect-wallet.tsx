...
const walletOptions: { type: WalletType; name: string; icon: React.ReactNode; color: string }[] = [
  {
    type: "metamask",
    name: "MetaMask",
    color: "from-orange-500/10 to-amber-500/10 border-orange-500/20 hover:border-orange-500/50 hover:bg-orange-500/5 text-orange-400",
    icon: (
      <svg className="w-8 h-8" viewBox="0 0 320 311.6" fill="currentColor">
        ...
        <path d="M114.5 198.5l-33-36.3 5-34.9-38.3 35.4 34 52.8z" fill="#E2761B"/>
        <path d="M205.5 198.5l33-36.3-5-34.9 38.3 35.4-34 52.8z" fill="#E2761B"/>
        ...
        <path d="M205.5 198.5l-45.5-7.3-31 7.3-4.9-59.5 4.9-19.5 31 43.5 31-43.5 4.9 19.5z" fill="#161616"/>
  ...
  },
  {
    type: "walletconnect",
    name: "WalletConnect",
    color: "from-blue-500/10 to-indigo-500/10 border-blue-500/20 hover:border-blue-500/50 hover:bg-blue-500/5 text-blue-400",
    icon: (
  ...
  },
  {
    ...
    color: "from-blue-600/10 to-sky-600/10 border-blue-600/20 hover:border-blue-600/50 hover:bg-blue-600/5 text-blue-500",
    icon: (
...
export function ConnectWallet() {
  ...
  const handleConnect = async (type: WalletType) => {
    ...
    try {
      ...
      console.error(err);
      setError(err?.message || "Failed to connect wallet. Make sure the extension is installed.");
    } finally {
    ...
    <div className="w-full max-w-md p-8 bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-3xl shadow-2xl relative overflow-hidden">
      ...
      <div className="relative flex flex-col items-center text-center gap-6">
        <div className="p-3 bg-zinc-800/80 border border-zinc-700/50 rounded-2xl shadow-inner text-zinc-400">
          <svg className="w-8 h-8 animate-pulse text-indigo-400" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
        ...
        <div className="flex flex-col gap-2">
          <h2 className="text-2xl font-bold tracking-tight text-zinc-100">Connect a Wallet</h2>
          <p className="text-sm text-zinc-400 max-w-xs">
            Select one of the supported wallets to authenticate and connect to ChainPay.
          </p>
        </div>
